...
class Food:
    ...
    def generate_random_pos(self, snake):
        while True:
            ...
            # Checking for (x, y) is free by the snake body
            overlap = False
...
score = 0          # The score
level = 1          # The level
score_for_next_level = 3  # every 3 points = next level

# font, for outputting score and level
...
while running:
    ...
    if snake.check_collision(food):
        # If food is eaten, increase the score, generate food in new place
        score += 1
        food.generate_random_pos(snake)

        # Checking whether should we pass onto the next level (every 3 points)
