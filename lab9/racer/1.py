...
background = pygame.image.load("need_for_speed/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("need_for_speed/Enemy.png")
...
class Coin(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale_by(pygame.image.load("need_for_speed/coin.png").convert_alpha(), 0.035)
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH-40), 0)  
...
class Coin2(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale_by(pygame.image.load("need_for_speed/coin2.png").convert_alpha(), 0.07)
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH-40), 0)  
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("need_for_speed/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('need_for_speed/crash.wav').play()
          time.sleep(0.5)
